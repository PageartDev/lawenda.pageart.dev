...
<nav id="main-nav" class="navbar navbar-expand-md navbar-light fixed-top bg-white border-bottom"
        ...
        <div class="woocommerce-icons d-flex align-items-center gap-3">
            ...
            <?php if (class_exists('WooCommerce')) :
                ...
                <div class="header-cart">
                    <?php if ( $use_cart_offcanvas ) : ?>
                        <!-- Offcanvasowy przycisk koszyka -->
                        <button
                                type="button"
                                class="nav-link btn btn-link p-0 position-relative"
                    ...
                    <?php else : ?>
                        <!-- Fallback: stary dropdown mini-cart gdy nie ma Bootstrap 5 -->
                        <div class="dropdown">
